---
name: clawdbot-logs
description: 分析 Clawdbot 的日志和诊断信息。当用户询问机器人的性能、响应时间、错误情况、会话统计信息、令牌使用情况、API 费用，或希望调试响应缓慢的问题时，可以使用此功能。
---
...
该工具可用于分析 Clawdbot 的性能、错误信息以及会话数据。
...
| 日志来源 | 存储位置 | 包含内容 |
|--------|----------|----------|
| 日志文件 | `journalctl --user -u clawdbot-gateway.service` | 会话状态、错误信息、工具执行情况 |
