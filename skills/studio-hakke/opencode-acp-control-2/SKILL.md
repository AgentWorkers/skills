...
description: 通过代理客户端协议（Agent Client Protocol, ACP）直接控制 OpenCode。可以启动会话、发送提示信息、恢复对话以及管理 OpenCode 的更新。
...
- 如果您在使用此技能时遇到问题，请在此处提交 issue：https://github.com/bjesuiter/opencode-acp-skill/issues
...
用户做出选择后（例如：“1”、“第一个”或“ses_451cd8ae...”）：
...
OpenCode 在重启时会自动更新。使用以下工作流程来检查和触发更新。
