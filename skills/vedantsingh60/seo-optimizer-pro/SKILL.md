...
**一款基于人工智能的SEO内容优化工具，适用于谷歌排名和AI搜索（AEO）**

利用人工智能分析并优化内容，以提高在传统谷歌搜索结果以及新兴AI搜索平台（如ChatGPT、Google AI Overviews、Claude等）中的可见性。
...
### 问题背景
SEO优化需要平衡多个目标：
- 内容必须在谷歌上获得良好的排名，同时满足技术SEO要求；
- AI搜索优化（AEO）是一个新的领域——让内容被ChatGPT、Google AI Overviews、Claude等AI平台引用；
- 手动分析可读性、关键词密度和标题结构非常耗时；
- 不清楚哪些因素真正影响排名，哪些只是最佳实践；
- 需要同时进行技术优化和吸引人的AI优化内容。

### 解决方案
结合人工智能和技术SEO审计来分析和优化内容，为传统谷歌排名和新兴AI搜索平台提供具体的建议。

### 重要性
- **AI搜索正在崛起**：ChatGPT、Google AI Overviews、Claude正成为主要的发现渠道；
- **2026年的趋势**：结构良好的高质量内容在两个系统中都能获得更好的排名；
- **数据驱动**：基于实际的SEO指标提供具体建议，而不仅仅是通用建议；
- **双重优化**：一次分析即可同时优化谷歌和AI搜索平台。
...
- 🔑 **关键词分析** - 关键词密度跟踪及自然整合建议；
- 📐 **内容结构** - 标题层次、段落长度、字数；
- 🎯 **技术SEO** - 元标签、链接分析、结构化数据；
- 🤖 **AI搜索优化** - 为ChatGPT引用和AI Overviews提供的建议。

### 多模型AI集成
支持多种AI模型，以增加灵活性：
- **Claude 4.5系列** - 最高质量的推理能力（Opus、Sonnet、Haiku）；
- **GPT-5.2系列** - 高级推理能力（Pro、Thinking、Instant）；
- **Gemini 2.5/3.0** - 快速高效的分析；
- **Llama 3.2/3.3** - 开源替代方案；
- **Mistral Large** - 高性能模型。
...
该技能本身是免费的。您需要直接向提供商按其标准费率支付API使用费用。

### ⚠️ 重要隐私声明

**您的内容将被发送给第三方AI提供商。** 在使用此技能处理敏感内容之前，请查看所选提供商的隐私政策：

- **Anthropic隐私政策**：https://www.anthropic.com/legal/privacy
- **OpenAI隐私政策**：https://openai.com/policies/privacy-policy
- **Google Gemini条款**：https://ai.google.dev/gemini-api/terms
- **OpenRouter隐私政策**：https://openrouter.ai/privacy
- **Mistral条款**：https://mistral.ai/terms/

**建议**：首先使用非敏感样本内容进行测试。每个提供商的数据保留政策可能不同。
...
### AEO的重要性
- **ChatGPT** 可以在回答中引用您的内容（如果格式正确）；
- **Google AI Overviews** 会从高度相关、权威的来源中提取信息；
- **Claude** 和其他AI系统优先考虑结构清晰的内容；
- **2026年的现实**：AI搜索正成为与谷歌并行的主要发现渠道。
...
**Q：SEO和AEO有什么区别？**
A：SEO针对谷歌的算法进行优化。AEO针对生成回答的AI聊天机器人进行优化。两者有很高的重叠性——对人类有用的内容通常也对AI有用。

**Q：这个技能支持英语以外的语言吗？**
A：可读性分析针对英语进行了优化，但关键词分析和AI建议适用于任何语言。

**Q：内容应该有多长？**
A：取决于主题的复杂性。一般建议：至少300个单词，全面覆盖需要1000个单词以上，权威页面需要2000个单词以上。

**Q：如果我的文档很长怎么办？**
A：该技能默认分析前2000个字符。对于更长的文档，可以将其分成几个部分分别进行分析。

**Q：这个工具会检查技术SEO（如页面速度）吗？**
A：该工具专注于内容优化。对于技术SEO（速度、移动设备适应性、可爬取性），请使用如Google PageSpeed Insights之类的工具。

**Q：可以同时优化多个关键词吗？**
A：可以！传递目标关键词列表。我们将分析每个关键词的密度，并提供具体的建议。

**Q：AEO评分的准确性如何？**
A：AEO仍在发展中。我们的建议基于2026年的AI搜索优化研究最佳实践。

**Q：这个技能可以从头生成SEO内容吗？**
A：不可以，该技能仅分析和优化现有内容。如需生成新内容，请先使用其他AI写作工具。
...
### ✅ 当前版本（v1.0.2）
- 内容可读性分析（Flesch-Kincaid）；
- 关键词密度跟踪；
- 技术SEO审计；
- 多提供商AI优化（Claude、GPT、Gemini、Llama、Mistral）；
- AEO特定建议；
- 影响估算。

### 🚧 即将推出
- **竞争对手分析** - 将您的内容与谷歌顶级结果进行比较；
- **批量分析** - 一次分析多页内容；
...
1. 在ClawhHub上免费获取此技能（无需订阅）；
2. 安装您所选提供商的SDK：`pip install anthropic`（或openai、google-generativeai、mistralai）；
3. 设置您所选提供商的API密钥（见上方凭证表）；
4. 分析您的第一篇内容。
...
**主要标签**：seo、content-optimization、aeo、ai-search、copywriting

**分类**：seo-tools、content-analysis、marketing-tech、ai-optimization

**特性**：keyword-analysis、readability-scoring、meta-tag-generation、technical-seo、ai-search-optimization
...
#### 🔒 安全与透明度改进
- **包含源代码** - 修复了许可证矛盾；包含源代码以确保透明度和安全审计；
- **许可证澄清** - 将“专有”改为“免费使用”，并明确个人使用的修改权限；
- **数据共享警告** - 添加了关于与第三方AI提供商数据共享的明确警告，并附上隐私政策链接；
- **元数据一致性** - 修复了注册表元数据，以准确反映所需的环境变量；
- **安装建议** - 更新了requirements.txt和文档，建议选择性安装SDK（并非所有包）。

#### 📝 文档更新
- 添加了GitHub仓库和可验证的支持联系人；
- 明确了哪些模型需要哪些API密钥；
- 添加了提供商隐私政策链接，以便用户知情同意；
- 更新了所有版本引用至1.0.6。
