...
- [Fathom](references/fathom.md) - 会议记录、摘要、摘要、Webhook
...
- [Granola](references/granola.md) - 会议笔记、摘要、查询（MCP）
...
- [Gmail](references/google-mail.md) - 消息、主题线索
