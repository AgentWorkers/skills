...
description: 生成世界卫生组织（WHO）推荐的儿童生长图表（包括身高、体重和BMI数据），并附带百分位数曲线。用户可根据需要下载官方的WHO参考数据。该工具适用于用户查询儿童生长情况、百分位数信息，或为他们的孩子生成生长图表时使用。
version: 1.2.3
...
- **按年龄计算的BMI**（0-19岁）
- 支持**男孩和女孩**
- 可根据需要从cdn.who.int下载WHO数据（数据会本地缓存）
- 将儿童的实际测量数据与趋势线叠加显示
