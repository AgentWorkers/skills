...
记录您的就寝时间和起床时间，并为睡眠质量评分（1-5分）；追踪您的睡眠时长模式；通过可视化图表查看每周的睡眠状况；获取包括平均睡眠时长和质量在内的长期睡眠统计数据；同时获得基于科学依据的睡眠改善建议。该工具还能帮助您判断自己是否达到了推荐的7-9小时睡眠时长。"
version: "1.0.0"
author: "BytesAgain"
...
SleepWell 帮助您了解并改善自己的睡眠习惯。它可以记录您上床睡觉的时间、起床的时间以及睡眠质量，从而让您能够观察到这些数据随时间的变化趋势。
...
- `today` — 查看今天的睡眠记录。
- `week` — 查看每周的睡眠时长图表。
- `stats` — 查看长期的睡眠统计数据（平均睡眠时长、睡眠质量、最佳/最差的睡眠夜晚）。
