...
## 描述
这是一个专为 OpenClaw 设计的视频处理工具，它利用 FFmpeg 来实现视频/音频的切割、格式转换和压缩功能。非常适合处理那些对文件大小有限制的应用程序（如微信、Lark、Telegram 等）中的视频文件。
...
### 系统要求
- 确保已安装 FFmpeg，并且 FFmpeg 可以通过 PATH 变量访问
- Python 3.7 或更高版本

### Python 依赖库
- 无（该工具通过 `subprocess` 模块调用 FFmpeg）
...
## 致谢
- 感谢 OpenClaw 团队提供的开发平台支持
- 感谢 FFmpeg 团队提供的强大的媒体处理工具

---

**作者身份**: yanyan@3c3d77679723a2fe95d3faf9d2c2e5a65559acbc97fef1ef37783514a80ae453