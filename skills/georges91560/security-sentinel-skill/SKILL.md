...
**检测到规避行为时的处罚：** 减7分，并将下一个检查的阈值提高至0.65
...
3. **性能开销**：每次检测大约50毫秒（对于大多数用例来说是可以接受的）
...
特此免费授予任何获取本软件及相关文档文件（“软件”）的人士以下权利：
- 无限制地使用、复制、修改、合并、发布、分发、再许可和/或出售软件的副本；
- 允许获得软件的人士也享有这些权利，但须遵守以下条件：
