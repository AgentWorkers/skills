...
description: OpenClaw的macOS安全监控功能
---
...
该工具提供了 **52 种以上的专业 macOS 安全监控功能**，包括：

- 📹 **摄像头监控**：实时查看哪些应用程序正在使用您的摄像头
- 🎤 **麦克风监控**：实时监控麦克风的使用情况
- 🔥 **防火墙状态**：检查您的 Mac 是否已启用防火墙
- 🔐 **VPN 检查器**：检测 VPN 连接状态
- 📡 **WiFi 扫描器**：分析 WiFi 安全性（WPA2/WPA3）
- 🔌 **端口扫描器**：列出所有开放的网络端口
- 🛑 **应用程序拦截器**：立即拦截可疑应用程序（仅限 Pro 版）

## 何时使用该工具？

当您需要执行以下操作时，请使用该工具：
- 检查是否有应用程序在秘密使用您的摄像头或麦克风
- 验证 Mac 的安全设置（防火墙、VPN）
- 扫描开放端口或 WiFi 漏洞
- 实时监控系统安全状况
...
- `open-ports`：列出所有开放的端口
- `wifi-scanner`：分析 WiFi 安全性
- `block-app <名称>`：拦截可疑应用程序
