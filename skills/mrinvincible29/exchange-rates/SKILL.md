---
name: exchange-rates
description: 从 XE.com 获取任意货币对之间的实时汇率。适用场景：用户询问货币兑换、汇率信息或需要将金额在不同货币之间进行转换（例如：“美元兑换成印度卢比”、“100 欧元等于多少英镑”、“美元的当前汇率是多少”、“500 欧元相当于多少人民币”）。不适用场景：用户询问股票价格、加密货币价格或金融市场相关内容——这些属于网页搜索范围，而非货币兑换服务。输出格式为 JSON，包含汇率、转换后的金额以及数据来源。展示结果时需明确标注单位汇率和总金额。
---
# 汇率（XE.com）
