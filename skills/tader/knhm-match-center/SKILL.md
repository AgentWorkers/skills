...
description: 从 KNHB Match Center (hockeyweerelt.nl) 查询荷兰曲棍球比赛的日程和结果。该资源可用于查找荷兰的曲棍球俱乐部、球队、即将举行的比赛以及比赛结果。
---
# KNHB比赛中心
...
- `home_score`, `away_score` — 对于即将进行的比赛，该字段可能为`null`
...
- **每支球队的室外和室内比赛都有独立的ID** — 请同时查询两者以获取完整的比赛日程
