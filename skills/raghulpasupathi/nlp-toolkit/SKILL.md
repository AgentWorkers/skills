...
version: 1.0.0
name: NLP Toolkit
description: 高级自然语言处理（NLP）技术：包括困惑度评分（perplexity scoring）、突发性分析（burstiness analysis）以及熵计算（entropy calculation）
author: NeoClaw Team
category: detection
tags:
  - nlp
...
该工具包提供高级的自然语言处理（NLP）分析功能，用于通过统计方法检测人工智能生成的内容。
